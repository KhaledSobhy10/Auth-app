...
export const ProfileSchema = z.object({
  ...
  password: z.string().min(8,{ message: 'password must be more than 8 characters'}).nullable(),
...
export const ProfileCreateInputSchema: z.ZodType<Prisma.ProfileCreateInput> = z.object({
  ...
  password: z.string().min(8,{ message: 'password must be more than 8 characters'}).optional().nullable(),
...
export const ProfileUpdateInputSchema: z.ZodType<Prisma.ProfileUpdateInput> = z.object({
  ...
  password: z.union([ z.string().min(8,{ message: 'password must be more than 8 characters'}),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
